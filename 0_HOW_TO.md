...
1. Double-click **`5_SetupWorkbook.bat`**
...
1. Double-click **`6_SetupShortcuts.bat`**
2. Two shortcuts appear on your Desktop:
   - **3_Open Email** — opens the original Outlook email for a selected row
